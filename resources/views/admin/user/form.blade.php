<div class="row">
    ...
    <div class="col-lg-6">
        <x-forms.input-group id="email" name="email" required="required" id="email"
            placeholder="Masukan Email Anda" label="Email" type="email"
    ...
    @if ($type == 'type')
        <div class="col-lg-6">
            <x-forms.input-group id="password" name="password" required="required" id="password"
                placeholder="Masukan Password Anda" label="Password" type="password"
                value="{{ $user->password ?? '' }}">
            </x-forms.input-group>
        </div>
        <div class="col-lg-6">
