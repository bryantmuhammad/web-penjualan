<div class="row">
    <div class="col-lg-6">
        <x-forms.input-group id="nama_supplier" name="nama_supplier" required="required" placeholder="Masukan Nama Supplier"
            label="Nama Supplier" value="{{ old('nama_supplier', $supplier->nama_supplier ?? '') }}">
        </x-forms.input-group>
    </div>
